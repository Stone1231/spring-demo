...
//
//	private static final transient Logger LOGGER = LoggerFactory.getLogger(UnsafeUtil.class);
//
...
//
//			// #fix
//			Field field = ClassUtil.getDeclaredField(Unsafe.class, "theUnsafe");
...
//		} catch (Exception ex) {
//			throw new RuntimeException("UnsafeUtil Failed to " + "get unsafe", ex);
//		}
//	}
//
//	/**
...
//			OBJECT_ARRAY_OFFSET = unsafe.arrayBaseOffset(Object[].class);
//		} catch (Exception ex) {
//			throw new RuntimeException("UnsafeUtil Failed to " + "new unsafe", ex);
//
//		}
//	}
//
...
//
//	/**
//	 * 類似 ArrayUtil.add(byte[] x, byte[] y)
//	 * 
//	 * 但多了個offset可以指定啟始位置
//	 * 
//	 * @param data
...
//		Field[] fs = ClassUtil.getDeclaredFields(c);
//		for (Field f : fs) {
