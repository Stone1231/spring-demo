...
public class AssertUtil {
	...
	/** The Constant LOGGER. */
	private static final transient Logger LOGGER = LoggerFactory.getLogger(AssertUtil.class);

	/**
	 * Instantiates a new AssertUtil.
	 */
	private AssertUtil() {
	...
	/**
	 * Gets the single instance of AssertUtil.
	 *
	 * @return single instance of AssertUtil
	 */
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if ((!(StringUtil.isNotEmpty(textToSearch))) || (!(StringUtil.isNotEmpty(substring)))
	...
	public static void isInstanceOf(Class<?> type, Object obj, String message) {
		...
		throw new IllegalArgumentException(new StringBuilder()
				.append((StringUtil.isNotEmpty(message)) ? new StringBuilder().append(message).append(" ").toString()
						: "")
